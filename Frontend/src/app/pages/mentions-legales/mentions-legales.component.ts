...
export class MentionsLegalesComponent implements OnInit {
  title ='Mentions légales | Atypik House | Location de logement | France';
...
addTag() {
    ...
    this.metaService.addTag({ name: 'description', content: "Mentions légales d'Atypik House, site de location de logement insolite en France" }); // Meta description de la page
